...
\DoxyCodeLine{524   cout << nEntries << endl;}
...
\DoxyCodeLine{598       cout << nNonEmpty\_all << \textcolor{charliteral}{'\(\backslash\)t'} << prob\_center\_all[nNonEmpty\_all] << \textcolor{charliteral}{'\(\backslash\)t'} << prob\_center\_all\_err[nNonEmpty\_all] << endl;}
...
\DoxyCodeLine{631 }
\DoxyCodeLine{632   cout << integral << endl;}
...
\DoxyCodeLine{228   \textcolor{keywordtype}{double} selfDHggcoupl[SIZE\_HGG][2] =\{ \{ 0 \} \};}
\DoxyCodeLine{229   \textcolor{keywordtype}{double} selfDHvvcoupl[SIZE\_HVV\_VBF][2] =\{ \{ 0 \} \};}
\DoxyCodeLine{230   \textcolor{keywordtype}{double} selfDHwwcoupl[SIZE\_HWW\_VBF][2] =\{ \{ 0 \} \};}
